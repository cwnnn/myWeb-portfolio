<template>
  <header class="header">
    ...
    <nav :class="['nav-links']">
      ...
      <router-link to="/q" class="nav-link" active-class="active">Projects</router-link>
   ...
   <button class="menu-toggle-button " @click="isOpen = !isOpen">☰</button>
    <ul v-if="isOpen" class="md:hidden">
      ...
      <li><router-link to="/q" class="nav-link" active-class="active" @click="isOpen = false">Projects</router-link></li>
...
<style scoped src="./RcsHeader.css">
</style>
