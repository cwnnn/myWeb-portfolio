export const projects = [
  ...
  },
  {
    ...
    shortDesc:
      "A system to automate bus operations and improve public transport efficiency.",
  ...
  },
  {
    ...
    shortDesc:
      "A minimalist time-tracking app with focus statistics and charts.",
  ...
  },
  {
    ...
    title: "100% Fair Wheel",
    shortDesc: "A wheel project where you can make 100% fair decisions.",
    desc: `Because I am usually very unlucky in life — especially with these wheels — I decided to create my own wheel and make my own luck (100% fair). This project can be used as a normal decision wheel. If you want, you can open the panel from the bottom-left button and set your own luck in your own way.

    This project is completely for education and entertainment purposes, and this is clearly shown on the domain. Please do not use it for harmful purposes.`,
    TechnologiesUsed:
      "Vue 3, TypeScript, Vite, TailwindCSS, Canvas API, Naive UI, Fuse.js",
    github: "https://github.com/cwnnn/fair-Choice-wheel",
    demo: "https://yuzdeyuzadilcark.vercel.app",
    to: "fair-wheel",
    img2: "/assets/projects/6-2.png",
    img3: "/assets/projects/6-3.png",
    img4: "/assets/projects/6-4.png",
    img5: "",
